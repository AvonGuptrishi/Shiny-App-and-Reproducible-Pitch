...
The application is running on (https://avonguptrishi.shinyapps.io/Shiny_App/)

ui.R, and Server.R Code in my github repository (https://github.com/AvonGuptrishi/Shiny-App-and-Reproducible-Pitch.git)
